...
const filePathsFromMetadataComponent = ({ fullName, type }, packageDir) => {
    ...
    if (((_a = type.strategies) === null || _a === void 0 ? void 0 : _a.adapter) === 'decomposed') {
    ...
    if (((_b = type.strategies) === null || _b === void 0 ? void 0 : _b.adapter) === 'matchingContentFile') {
    ...
    if (((_c = type.strategies) === null || _c === void 0 ? void 0 : _c.adapter) === 'mixedContent' && type.inFolder && !type.strategies.transformer) {
    ...
    if (((_d = type.strategies) === null || _d === void 0 ? void 0 : _d.adapter) === 'mixedContent' && !type.inFolder) {
        return [
            (0, path_1.join)(packageDirWithTypeDir, 
            // registry doesn't have a suffix for EB (it comes down inside the mdapi response)
            `${fullName}.${((_e = type.strategies) === null || _e === void 0 ? void 0 : _e.transformer) === 'staticResource' ? type.suffix : 'site'}${constants_1.META_XML_SUFFIX}`),
            (0, path_1.join)(packageDirWithTypeDir, `${fullName}`),
        ];
    }
    // lwc, aura, waveTemplate
    if (((_f = type.strategies) === null || _f === void 0 ? void 0 : _f.adapter) === 'bundle') {

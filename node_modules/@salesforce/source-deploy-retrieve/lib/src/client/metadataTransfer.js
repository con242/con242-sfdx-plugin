...
class MetadataTransfer {
    ...
    async pollStatus(frequencyOrOptions, timeout) {
        ...
        (_a = pollingOptions.frequency) !== null && _a !== void 0 ? _a : (pollingOptions.frequency = kit_1.Duration.milliseconds(this.calculatePollingFrequency()));
        (_b = pollingOptions.timeout) !== null && _b !== void 0 ? _b : (pollingOptions.timeout = kit_1.Duration.minutes(60));
    ...
    calculatePollingFrequency() {
        var _a;
        const size = ((_a = this.components) === null || _a === void 0 ? void 0 : _a.getSourceComponents().toArray().length) || 0;
